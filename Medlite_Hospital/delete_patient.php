...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($patient_id != "" && $patient_name != "") {
        $check = "SELECT * FROM patients WHERE id = '$patient_id' AND name = '$patient_name'";
        $result = mysqli_query($con, $check);

        if (mysqli_num_rows($result) > 0) {
            $delete = "DELETE FROM patients WHERE id = '$patient_id' AND name = '$patient_name'";
            mysqli_query($con, $delete);
            $msg = "✅ Patient deleted successfully!";
        } else {
            $msg = "❌ No patient found with the given ID and Name.";
        }
    } else {
        $msg = "⚠️ Please provide both Patient ID and Name.";
    }
}
?>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <a class="active" href="manage_patients.php">🗑️ Delete Patient</a>
        ...
        <main class="main-content">
            <header class="header">
                <div class="welcome">
                    <h2>Delete Existing Patient 🩺</h2>
                    <p>Fill in the details to delete an existing patient from the system.</p>
                </div>
            </header>
